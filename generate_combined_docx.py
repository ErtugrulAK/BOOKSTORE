...
def main():
    ...
    # --- SECTION 3: KVKK BİLGİLENDİRMESİ ---
    add_heading_styled(doc, "BÖLÜM 3: KİŞİSEL VERİLERİN KORUNMASI KANUNU (KVKK) BİLGİLENDİRMESİ", level=1)
    
    kvkk_text = (
        "KVKK Bilgilendirmesi: Üniversitemiz; kişisel verilerin işlenmesi esnasında hukuka ve dürüstlük kurallarına "
        "uygun hareket etmekte; orantılılık ve gereklilik prensiplerini dikkate almakta, kişisel verileri, veri işleme "
        "amaçlarına uygun düşecek seviyede işlemekte olup, Aydınlatma ve Açık Rıza Metinlerine https://kvkk.deu.edu.tr/ "
        "adresinden ulaşılabilmektedir."
    )
    add_p_styled(doc, kvkk_text, space_after=12)

    # Save to file
    out_filename = "DEÜ Kitap Satış - Yasal Sözleşmeler.docx"
